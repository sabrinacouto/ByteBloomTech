...
const Acessibilidade = () =>{
  ...
  <div className="flex flex-col md:flex-row items-center bg-white rounded-xl w-full md:max-w-[50rem] h-auto md:h-[20rem]  gap-5 md:gap-10 pl-3 sm:pl-0">
    <div className="ml-10">
    {showImages &&<Image src={iconeAcessibilidade} className= "h-[13rem]"alt="Icone de Acessibilidade da Salesforce" />}
    </div>
    <p className="w-full md:w-[25rem] text-xl text-[#003652] mt-5 md:mt-0">
      ...
      <div className="grids grids-cols-1 sm:grid-cols-2 md:grid-cols-3 flex flex-wrap mt-[9rem] justify-center items-center gap-[19rem] md:gap-[9rem]">
                    ...
                    {showImages &&<Image src={aumentoFonte} alt="Icone do menu de aumento de fonte" />}
                    ...
                    <div className="cards bg-white w-[25rem] h-[40rem] p-3 rounded-xl">
                    {showImages &&<Image src={libras} alt="Icone do menu para habilitar a ferramenta de Libras" />}
                    ...
                    <div className="cards bg-white w-[25rem] h-[40rem] p-3 rounded-xl">
                    {showImages &&<Image src={audioDescricao} alt="Icone do menu para habilitar a audiodeescrição" />}
                    ...
                    <div className="cards bg-white w-[25rem] h-[40rem] p-3 rounded-xl">
                    {showImages &&<Image src={daltonismo} alt="Icone do menu para habilitar a ferramenta de auxilio para daltonismo" />}
                    ...
                    <div className="cards bg-white w-[25rem] h-[40rem] p-3 rounded-xl">
                    {showImages &&<Image src={diminuirFont} alt="Icone do menu para diminuir a fonte" />}
